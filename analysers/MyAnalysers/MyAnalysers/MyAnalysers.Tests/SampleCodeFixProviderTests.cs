...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<MyAnalysers.SampleSyntaxAnalyzer,
        MyAnalysers.SampleCodeFixProvider>;

namespace MyAnalysers.Tests;
