...
### MyAnalysers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [MyAnalysers.Sample.csproj](../MyAnalysers.Sample/MyAnalysers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 
